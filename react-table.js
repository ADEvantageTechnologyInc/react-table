(function (global, factory) {
  ...
  */
  ...
  function asPx(value) {
    value = Number(value);
    return Number.isNaN(value) ? null : "".concat(value, "px");
  }
        ...
        _createClass(_class, [{
          ...
          value: function componentWillReceiveProps(nextProps, nextState) {
            ...
            defaultableOptions.forEach(function (x) {
              var defaultName = "default".concat(x.charAt(0).toUpperCase() + x.slice(1));
            ...
            resettableOptions.forEach(function (x) {
              if (oldState[x] !== newState[x]) {
                ...
                var optionName = "".concat(baseName, "ed");
                var defaultName = "default".concat(optionName.charAt(0).toUpperCase() + optionName.slice(1));
      ...
      function (_Base) {
        ...
        _createClass(_class, [{
          ...
          value: function getResolvedState(props, state) {
            var resolvedState = _objectSpread({}, _.compactObject(this.state), _.compactObject(this.props), _.compactObject(state), _.compactObject(props));
          ...
          value: function getDataModel(newState, dataChanged) {
            ...
            var makeDecoratedColumn = function makeDecoratedColumn(column, parentColumn) {
              ...
              if (column.expander) {
                dcol = _objectSpread({}, _this.props.column, _this.props.expanderDefaults, column);
              } else {
                dcol = _objectSpread({}, _this.props.column, column);
            ...
            if (pivotBy.length) {
              ...
              var pivotColumnGroup = {
                ...
                columns: pivotColumns.map(function (col) {
                  return _objectSpread({}, _this.props.pivotDefaults, col, {
                    pivoted: true
                  });
              ...
              if (pivotIndex >= 0) {
                pivotColumnGroup = _objectSpread({}, visibleColumns[pivotIndex], pivotColumnGroup);
            ...
            var addHeader = function addHeader(columns, column) {
              headerGroups.push(_objectSpread({}, _this.props.column, column, {
                columns: columns
              }));
              currentSpan = [];
            ...
            if (pivotBy.length) {
              var groupRecursively = function groupRecursively(rows, keys) {
                ...
                groupedRows = groupedRows.map(function (rowGroup) {
                  ...
                  return _objectSpread({}, rowGroup, (_objectSpread2 = {}, _defineProperty(_objectSpread2, subRowsKey, subRows), _defineProperty(_objectSpread2, aggregatedKey, true), _objectSpread2), aggregate(subRows));
                });
                return groupedRows;
              };
          ...
          value: function filterData(data, filtered, defaultFilterMethod, allVisibleColumns) {
            ...
            if (filtered.length) {
              ...
              filteredData = filteredData.map(function (row) {
                ...
                return _objectSpread({}, row, _defineProperty({}, _this2.props.subRowsKey, _this2.filterData(row[_this2.props.subRowsKey], filtered, defaultFilterMethod, allVisibleColumns)));
              }).filter(function (row) {
                if (!row[_this2.props.subRowsKey]) {
                  return true;
                }
          ...
          value: function sortData(data, sorted) {
            ...
            var sortedData = (this.props.orderByMethod || _.orderBy)(data, sorted.map(function (sort) {
              ...
              return function (a, b) {
                return _this3.props.defaultSortMethod(a[sort.id], b[sort.id], sort.desc);
              };
            ...
            sortedData.forEach(function (row) {
              ...
              row[_this3.props.subRowsKey] = _this3.sortData(row[_this3.props.subRowsKey], sorted, sortMethodsByColumnID);
            });
            return sortedData;
          }
        }, {
  ...
  function (_Component) {
    ...
    function ReactTablePagination(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactTablePagination).call(this));
      _this.getSafePage = _this.getSafePage.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.changePage = _this.changePage.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.applyPage = _this.applyPage.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.state = {
        page: props.page
      };
      return _this;
    ...
    _createClass(ReactTablePagination, [{
      ...
      value: function render() {
        ...
        return React__default.createElement("div", {
        ...
        }, page + 1), ' ', this.props.ofText, " ", React__default.createElement("span", {
          ...
          return (// eslint-disable-next-line react/no-array-index-key
            React__default.createElement("option", {
              key: i,
              value: option
            }, "".concat(option, " ").concat(_this2.props.rowsText))
          );
        })))), React__default.createElement("div", {
          className: "-next"
  ...
  var defaultProps = {
    ...
    TheadComponent: function TheadComponent(_ref2) {
    ...
    TbodyComponent: function TbodyComponent(_ref3) {
    ...
    TrGroupComponent: function TrGroupComponent(_ref4) {
    ...
    TrComponent: function TrComponent(_ref5) {
      var children = _ref5.children,
          className = _ref5.className,
          rest = _objectWithoutProperties(_ref5, ["children", "className"]);
    ...
    ThComponent: function ThComponent(_ref6) {
      var toggleSort = _ref6.toggleSort,
          className = _ref6.className,
          children = _ref6.children,
          rest = _objectWithoutProperties(_ref6, ["toggleSort", "className", "children"]);

      return (// eslint-disable-next-line jsx-a11y/click-events-have-key-events
        React__default.createElement("th", _extends({
    ...
    TdComponent: function TdComponent(_ref7) {
      var toggleSort = _ref7.toggleSort,
          className = _ref7.className,
          children = _ref7.children,
          rest = _objectWithoutProperties(_ref7, ["toggleSort", "className", "children"]);
    ...
    ExpanderComponent: function ExpanderComponent(_ref9) {
      var isExpanded = _ref9.isExpanded;
      return React__default.createElement("div", {
        className: classnames('rt-expander', isExpanded && '-open')
      }, "\u2022");
    },
    PivotValueComponent: function PivotValueComponent(_ref10) {
      var subRows = _ref10.subRows,
          value = _ref10.value;
      return React__default.createElement("span", null, value, " ", subRows && "(".concat(subRows.length, ")"));
    },
    AggregatedComponent: function AggregatedComponent(_ref11) {
      var subRows = _ref11.subRows,
    ...
    LoadingComponent: function LoadingComponent(_ref12) {
      var className = _ref12.className,
          loading = _ref12.loading,
          loadingText = _ref12.loadingText,
          rest = _objectWithoutProperties(_ref12, ["className", "loading", "loadingText"]);
  ...
  */
  ...
  function (_Methods) {
    ...
    function ReactTable(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(ReactTable).call(this));
      _this.getResolvedState = _this.getResolvedState.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.getDataModel = _this.getDataModel.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.getSortedData = _this.getSortedData.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.fireFetchData = _this.fireFetchData.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.getPropOrState = _this.getPropOrState.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.getStateOrProp = _this.getStateOrProp.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.filterData = _this.filterData.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.sortData = _this.sortData.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.getMinRows = _this.getMinRows.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      ...
      _this.filterColumn = _this.filterColumn.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.resizeColumnStart = _this.resizeColumnStart.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.resizeColumnEnd = _this.resizeColumnEnd.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.resizeColumnMoving = _this.resizeColumnMoving.bind(_assertThisInitialized(_assertThisInitialized(_this)));
      _this.state = {
      ...
      value: function render() {
        ...
        var recurseRowsViewIndex = function recurseRowsViewIndex(rows) {
          ...
          return [rows.map(function (row, i) {
            ...
            var rowWithViewIndex = _objectSpread({}, row, {
              _viewIndex: index
            });
        ...
        var finalState = _objectSpread({}, resolvedState, {
          startRow: startRow,
          endRow: endRow,
          pageRows: pageRows,
          minRows: minRows,
        ...
        var makeHeaderGroup = function makeHeaderGroup(column, i) {
          ...
          var styles = _objectSpread({}, column.headerStyle, theadGroupThProps.style, columnHeaderProps.style);

          var rest = _objectSpread({}, theadGroupThProps.rest, columnHeaderProps.rest);
        ...
        var makeHeaderGroups = function makeHeaderGroups() {
          ...
          return React__default.createElement(TheadComponent, _extends({
            ...
            style: _objectSpread({}, theadGroupProps.style, {
              minWidth: "".concat(rowMinWidth, "px")
            })
        ...
        var makeHeader = function makeHeader(column, i) {
          ...
          var styles = _objectSpread({}, column.headerStyle, theadThProps.style, columnHeaderProps.style);

          var rest = _objectSpread({}, theadThProps.rest, columnHeaderProps.rest);
        ...
        var makeHeaders = function makeHeaders() {
          ...
          return React__default.createElement(TheadComponent, _extends({
            ...
            style: _objectSpread({}, theadProps.style, {
              minWidth: "".concat(rowMinWidth, "px")
            })
        ...
        var makeFilter = function makeFilter(column, i) {
          ...
          var styles = _objectSpread({}, column.headerStyle, theadFilterThProps.style, columnHeaderProps.style);

          var rest = _objectSpread({}, theadFilterThProps.rest, columnHeaderProps.rest);
        ...
        var makeFilters = function makeFilters() {
          ...
          return React__default.createElement(TheadComponent, _extends({
            ...
            style: _objectSpread({}, theadFilterProps.style, {
              minWidth: "".concat(rowMinWidth, "px")
            })
        ...
        var makePageRow = function makePageRow(row, i) {
          ...
          return React__default.createElement(React.Fragment, {
            key: "row-".concat(i)
          }, React__default.createElement(TrComponent, _extends({
            ...
            var styles = _objectSpread({}, tdProps.style, column.style, columnProps.style);

            var cellInfo = _objectSpread({}, rowInfo, {
            ...
            if (cellInfo.pivoted) {
              ...
              if (isBranch) {
                // isPivot
                resolvedCell = _.normalizeComponent(ResolvedPivotComponent, _objectSpread({}, cellInfo, {
        ...
        var makeColumnFooter = function makeColumnFooter(column, i) {
          ...
          var styles = _objectSpread({}, tFootTdProps.style, column.style, columnProps.style, columnFooterProps.style);
        ...
        var makeColumnFooters = function makeColumnFooters() {
          ...
          return React__default.createElement(TfootComponent, _extends({
            ...
            style: _objectSpread({}, tFootProps.style, {
              minWidth: "".concat(rowMinWidth, "px")
            })
        ...
        var makeTable = function makeTable() {
          ...
          return React__default.createElement("div", _extends({
            ...
            style: _objectSpread({}, style, rootProps.style)
          }, rootProps.rest), showPagination && showPaginationTop ? React__default.createElement("div", {
            className: "pagination-top"
          }, pagination) : null, React__default.createElement(TableComponent, _extends({
            ...
            style: _objectSpread({}, tBodyProps.style, {
              minWidth: "".concat(rowMinWidth, "px")
            })
          ...
          }, pagination) : null, !pageRows.length && React__default.createElement(NoDataComponent, noDataProps, _.normalizeComponent(noDataText)), React__default.createElement(LoadingComponent, _extends({
            loading: loading,
  ...
  _defineProperty(ReactTable, "propTypes", propTypes$1);

  _defineProperty(ReactTable, "defaultProps", defaultProps);
